...
router.post('/beta/decision/v1/route_cont', function (req, res) {
  // Make a variable and give it the value from 'prnQuestion'
...
// if (myCheckboxes && myCheckboxes.includes("apple")) 
...
const ur_routes = require('./routes/ur_routes.js');;


//copy the router use and update the sprint version

router.use(lettergeneratorV1);
router.use(ur_routes);
