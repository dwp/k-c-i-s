...
router.post('/beta/incident_manager_journey/v6/route_police', (req, res) => {
...
router.post('/beta/incident_manager_journey/v6/route_colleague', (req, res) => {
  // Make a variable and give it the value from 'prnQuestion'
...
router.post('/beta/incident_manager_journey/v6/route_witness2', (req, res) => {
  // Make a variable and give it the value from 'prnQuestion'
  var onBehalf = req.session.data['contact']
    // Check whether the variable matches a condition
    if (onBehalf == "you") {
...
// Route Incident Manager Journey - witness on behalf of 
router.post('/beta/incident_manager_journey/v6/04add_witness', (req, res) => {
  // Make a variable and give it the value from 'prnQuestion'
...
router.post('/beta/incident_manager_journey/v6/wit01add_witness', (req, res) => {
  // Make a variable and give it the value from 'prnQuestion'
